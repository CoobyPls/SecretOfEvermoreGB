...
Copy the whole `VBlankTileStreamerPlugin` folder into your GB Studio project's `plugins` folder.
...
Put it somewhere out of the way, or hide it until the stream is done. The demo project keeps one reusable spell actor around and swaps graphics into it as needed.
...
The demo project does this in the `Stars` scene.
