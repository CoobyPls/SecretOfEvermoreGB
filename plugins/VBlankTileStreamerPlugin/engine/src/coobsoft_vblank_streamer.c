...
#include "data/sprite_crush_tileset.h"
#include "data/sprite_flash_tileset.h"
#include "data/sprite_gb_storm_tileset.h"
...
static const vstream_asset_t vstream_assets[] = {
    { &sprite_crush_tileset, BANK(sprite_crush_tileset), 0, 0u },
    { &sprite_flash_tileset, BANK(sprite_flash_tileset), 0, 0u },
    { &sprite_gb_storm_tileset, BANK(sprite_gb_storm_tileset), 0, 0u },
    { 0, 0u, 0, 0u },
    { 0, 0u, 0, 0u },
    { 0, 0u, 0, 0u },
    { 0, 0u, 0, 0u },
